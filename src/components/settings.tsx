...
import DeleteAccount from "../app/settings/_components/deleteAccount";
...
export default function Settings() {
    ...
    const [deleteAccountState, setDeleteAccountSate] = useState(false);
            ...
            <div className="mt-0 sm:mt-5 rounded-lg bg-card-background border-1 border-borders">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <Setting title="Eliminar cuenta" description="Se eliminará tu cuenta y todo su contenido" icon={require("../../public/delete-icon.svg")} iconcolor="#E24B4A" iconbgcolor="var(--transparent-red)" action={() => setDeleteAccountSate(!deleteAccountState)} />
                        { deleteAccountState ? <DeleteAccount /> : null }
                    </div>
                </div>
            </div>
        </>
