    ...
    return (
        <div className="bg-card-background mt-1 sm:mt-5 px-3 py-2 min-h-50 rounded-lg border-1 border-borders">
            <div className="flex gap-3">
                {image ? <Image src={image} width={24} height={24} alt="User Picture" /> : <div className="w-12 h-12 flex items-center justify-center text-white font-semibold bg-dark-purple rounded-full">
                    JD
                </div>}
