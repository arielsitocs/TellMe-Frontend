...
import { formatName, getInitials, getSoftUserColor } from "@/src/utils/name"

export default function User({ image, firstName, lastName, followers, color }: UserDataTypes) {
    const userColor = color || getSoftUserColor(firstName, lastName)
